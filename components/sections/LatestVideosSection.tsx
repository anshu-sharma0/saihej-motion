      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          ...
          <div className="flex items-center gap-3 self-end md:self-auto">
            <button
              onClick={prevSlide}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-white border-2 border-zinc-200 text-[#1F2937] hover:border-[#FF4D4D] hover:text-[#FF4D4D] transition-colors shadow-md"
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video w-full bg-zinc-900">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#3B82F6] text-white shadow-2xl transition-transform duration-300 group-hover:scale-110">
              ...
              <div className="flex flex-col flex-grow p-6">
                ...
                <h3 className="text-xl font-extrabold text-[#1F2937] group-hover:text-[#3B82F6] transition-colors line-clamp-1 mb-2">
                  {video.title}
                </h3>
